...
public class GetRequest10 {
 @Test
   ...
   response.prettyPrint();
     ...
     response.then().assertThat().body("data[4].employee_name", Matchers.equalTo("Airi Satou"),
             372000,Matchers.equalTo("data[5].employee_salary"));
     response.then().assertThat().statusCode(200).body("data[4].employee_name", Matchers.equalTo("Airi Satou"),
                     372000,Matchers.equalTo("data[5].employee_salary"));
     ...
     String besinciisim=json.getString("data[4].employee_name");
     System.out.println(besinciisim.equals("Airi Satou"));




     List<String> liste=json.getList("data.id");
     System.out.println(liste.size()==24?"24 adet isci var":"malesef isci sayisi "+liste.size());
